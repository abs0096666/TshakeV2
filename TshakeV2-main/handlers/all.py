...
def allGP(client, message,redis):
  ...
  if text :
    ...
    if re.search(c.sors,text):
      kb = InlineKeyboardMarkup([[InlineKeyboardButton("قناه السورس 📢", url="t.me/homespeople2")],[InlineKeyboardButton("تواصل السورس 💬", url="t.me/homespeople2")],[InlineKeyboardButton("شروحات السورس 📑", url="t.me/اهل البيت بين الاتباع والابتداع")]])
